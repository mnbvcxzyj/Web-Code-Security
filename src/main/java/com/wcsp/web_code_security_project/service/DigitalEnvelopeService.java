...
import exception.DecryptException;
...
public class DigitalEnvelopeService {
    ...
    // 전자 서명 생성 및 파일 저장
    public void createDigitalSign(String data, PrivateKey privateKey, SecretKey secretKey, String signFile, String contractFile) throws EncryptException {
        ...
        try {
            ...
            throw new EncryptException("서명 생성 or 파일 저장 중 오류 발생", e);
        }
    }

    // 전자 봉투 생성 (사용자 정의 예외 사용)
    public void createDigitalEnvelope(PublicKey publicKey, SecretKey secretKey, String envelopeFile) throws EncryptException {
        try {
            ...
            throw new EncryptException("전자 봉투 생성 중 오류 발생", e);
        }
    }

    public boolean verifyEnvelope(String envelopeFile, String signFile, String contractFile, PrivateKey privateKey, PublicKey publicKey) throws DecryptException {
        try {
            ...
            throw new DecryptException("전자 봉투 검증 중 오류 발생", e);
        }
    }
}
